...
module ISSUE_stage(
  ...
  (* keep = "true", equivalent_register_removal = "no", max_fanout = 16 *)
  reg [4:0]  es_dest_0;
  // InstBuffer consume feedback uses a dedicated physical copy of the lane0
  // destination tag.  It captures the same issue packet as es_dest_0, but
  // keeps the multiply RAW/consume cone separate from the forwarding cone.
