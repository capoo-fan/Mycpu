...
1c0011bc:	288621ad 	ld.w	$r13,$r13,392(0x188)
./kern/init.S:177
    st.w        s6,t1,0x0
...
1c0011cc:	288641ad 	ld.w	$r13,$r13,400(0x190)
./kern/init.S:181
    st.w        s2,t1,0x0
...
1c0011d8:	2885a1ad 	ld.w	$r13,$r13,360(0x168)
./kern/init.S:183
    st.w        s3,t1,0x0
...
1c0011e4:	288541ad 	ld.w	$r13,$r13,336(0x150)
./kern/init.S:185
    st.w        s4,t1,0x0
...
1c0011f4:	288571ad 	ld.w	$r13,$r13,348(0x15c)
./kern/init.S:193
    la.global   t2,SerialData
1c0011f8:	1c00002e 	pcaddu12i	$r14,1(0x1)
1c0011fc:	2884b1ce 	ld.w	$r14,$r14,300(0x12c)
./kern/init.S:194
    st.w        t2,t1,0x0
...
1c001208:	288581ad 	ld.w	$r13,$r13,352(0x160)
./kern/init.S:196
    la.global   t2,SerialStat
1c00120c:	1c00002e 	pcaddu12i	$r14,1(0x1)
1c001210:	288481ce 	ld.w	$r14,$r14,288(0x120)
./kern/init.S:197
    st.w        t2,t1,0x0
...
1c001220:	2884c1ad 	ld.w	$r13,$r13,304(0x130)
./kern/init.S:202
    li.w        t2,0x1f000000
...
1c001230:	2884e1ad 	ld.w	$r13,$r13,312(0x138)
./kern/init.S:205
    li.w        t2,0x1f000005
...
1c001244:	28844063 	ld.w	$r3,$r3,272(0x110)
./kern/init.S:210
    or          fp,sp,zero
...
1c001250:	2883a18c 	ld.w	$r12,$r12,232(0xe8)
./kern/init.S:212
    la.global   t1,uregs_sp             // 写入用户空间备份
1c001254:	1c00002d 	pcaddu12i	$r13,1(0x1)
1c001258:	288401ad 	ld.w	$r13,$r13,256(0x100)
./kern/init.S:213
    st.w        t0,t1,0x0
...
1c001264:	288391ad 	ld.w	$r13,$r13,228(0xe4)
./kern/init.S:215
    st.w        t0,t1,0x0
...
1c001270:	288381ad 	ld.w	$r13,$r13,224(0xe0)
./kern/init.S:219
    ld.w        t1, t1, 0
...
1c0012b0:	028112f7 	addi.w	$r23,$r23,68(0x44)
./kern/init.S:237
    ld.b        a0,s0,0x0
...
1c0012c0:	2882818c 	ld.w	$r12,$r12,160(0xa0)
./kern/init.S:241
    jirl        ra,t0,0x0
...
1c0012d4:	2881e18c 	ld.w	$r12,$r12,120(0x78)
./kern/init.S:245
    jirl        zero,t0,0x0
...
1c0012e0:	2881318c 	ld.w	$r12,$r12,76(0x4c)
./kern/shell.S:25
    jirl        ra,t0,0x0
...
./kern/shell.S:33
    beq         a0,t0,.OP_A
1c001300:	5800b08c 	beq	$r4,$r12,176(0xb0) # 1c0013b0 <.OP_A>
./kern/shell.S:34
    ori         t0,zero,SH_OP_G
1c001304:	03811c0c 	ori	$r12,$r0,0x47
./kern/shell.S:35
    beq         a0,t0,.OP_G
1c001308:	58012c8c 	beq	$r4,$r12,300(0x12c) # 1c001434 <.OP_G>
./kern/shell.S:36
    b           .DONE                   // 错误的操作符，默认忽略
1c00130c:	50027c00 	b	636(0x27c) # 1c001588 <.DONE>
...
1c001334:	2880b18c 	ld.w	$r12,$r12,44(0x2c)
./kern/shell.S:50
    jirl        ra,t0,0x0
...
./kern/shell.S:57
    b           .DONE
1c001350:	50023800 	b	568(0x238) # 1c001588 <.DONE>
...
1c001364:	28bf618c 	ld.w	$r12,$r12,-40(0xfd8)
./kern/shell.S:65
    jirl        ra,t0,0x0
...
1c001374:	28bf218c 	ld.w	$r12,$r12,-56(0xfc8)
./kern/shell.S:68
    jirl        ra,t0,0x0
...
1c001380:	58002300 	beq	$r24,$r0,32(0x20) # 1c0013a0 <.OP_D_DONE>
./kern/shell.S:74

.LC1:
    ld.b        a0,s0,0x0               // 读取字节
1c001384:	280002e4 	ld.b	$r4,$r23,0
./kern/shell.S:75
    addi.w      s1,s1,-1                // 滚动计数器
1c001388:	02bfff18 	addi.w	$r24,$r24,-1(0xfff)
./kern/shell.S:76
    la.global    t0,WRITESERIAL          // 写入串口
1c00138c:	1c00002c 	pcaddu12i	$r12,1(0x1)
1c001390:	28bf418c 	ld.w	$r12,$r12,-48(0xfd0)
./kern/shell.S:77
    jirl        ra,t0,0x0
1c001394:	4c000181 	jirl	$r1,$r12,0
./kern/shell.S:78
    addi.w      s0,s0,0x1               // 移动打印指针
1c001398:	028006f7 	addi.w	$r23,$r23,1(0x1)
./kern/shell.S:79
    bne         s1,zero,.LC1            // 打印循环
1c00139c:	5fffeb00 	bne	$r24,$r0,-24(0x3ffe8) # 1c001384 <.OP_D+0x30>
...
.OP_D_DONE:
    ld.w        s0,sp,0x0               // 恢复s0,s1
1c0013a0:	28800077 	ld.w	$r23,$r3,0
./kern/shell.S:83
    ld.w        s1,sp,0x4
1c0013a4:	28801078 	ld.w	$r24,$r3,4(0x4)
./kern/shell.S:84
    addi.w      sp,sp,0x8
1c0013a8:	02802063 	addi.w	$r3,$r3,8(0x8)
./kern/shell.S:85
    b           .DONE
1c0013ac:	5001dc00 	b	476(0x1dc) # 1c001588 <.DONE>
...
.OP_A:                                  // 操作 - 写入内存num字节，num为4的倍数
    addi.w      sp,sp,-8                // 保存s0,s1
1c0013b0:	02bfe063 	addi.w	$r3,$r3,-8(0xff8)
./kern/shell.S:89
    st.w        s0,sp,0x0
1c0013b4:	29800077 	st.w	$r23,$r3,0
./kern/shell.S:90
    st.w        s1,sp,0x4
1c0013b8:	29801078 	st.w	$r24,$r3,4(0x4)
./kern/shell.S:92

    la.global    t0,READSERIALWORD
1c0013bc:	1c00002c 	pcaddu12i	$r12,1(0x1)
1c0013c0:	28bdf18c 	ld.w	$r12,$r12,-132(0xf7c)
./kern/shell.S:93
    jirl        ra,t0,0x0
1c0013c4:	4c000181 	jirl	$r1,$r12,0
./kern/shell.S:94
    or          s0,a0,zero              // 获得addr
1c0013c8:	00150097 	move	$r23,$r4
./kern/shell.S:95
    la.global    t0,READSERIALWORD
1c0013cc:	1c00002c 	pcaddu12i	$r12,1(0x1)
1c0013d0:	28bdb18c 	ld.w	$r12,$r12,-148(0xf6c)
./kern/shell.S:96
    jirl        ra,t0,0x0
1c0013d4:	4c000181 	jirl	$r1,$r12,0
./kern/shell.S:97
    or          s1,a0,zero              // 获得num
1c0013d8:	00150098 	move	$r24,$r4
./kern/shell.S:98
    beq         s1,zero,.OP_A_DONE
1c0013dc:	58004b00 	beq	$r24,$r0,72(0x48) # 1c001424 <.OP_A_DONE>
./kern/shell.S:99
    or          t0,s0,s1
1c0013e0:	001562ec 	or	$r12,$r23,$r24
./kern/shell.S:100
    andi        t0,t0,0x3               // addr和num都必须4字节对齐
1c0013e4:	03400d8c 	andi	$r12,$r12,0x3
./kern/shell.S:101
    bne         t0,zero,.OP_A_DROP
1c0013e8:	5c002980 	bne	$r12,$r0,40(0x28) # 1c001410 <.OP_A_DROP>
./kern/shell.S:102
    srli.w      s1,s1,2                 // num除4，获得字数
1c0013ec:	00448b18 	srli.w	$r24,$r24,0x2
./kern/shell.S:104
.LC2:                                   // 每次写入一字
    la.global    t0,READSERIALWORD       // 从串口读入一字
1c0013f0:	1c00002c 	pcaddu12i	$r12,1(0x1)
1c0013f4:	28bd218c 	ld.w	$r12,$r12,-184(0xf48)
./kern/shell.S:105
    jirl        ra,t0,0x0
1c0013f8:	4c000181 	jirl	$r1,$r12,0
./kern/shell.S:106
    st.w        a0,s0,0x0               // 写内存一字
1c0013fc:	298002e4 	st.w	$r4,$r23,0
./kern/shell.S:107
    addi.w      s1,s1,-1                // 滚动计数器
1c001400:	02bfff18 	addi.w	$r24,$r24,-1(0xfff)
./kern/shell.S:108
    addi.w      s0,s0,0x4               // 移动写指针
1c001404:	028012f7 	addi.w	$r23,$r23,4(0x4)
./kern/shell.S:109
    bne         s1,zero,.LC2            // 写循环
1c001408:	5fffeb00 	bne	$r24,$r0,-24(0x3ffe8) # 1c0013f0 <.OP_A+0x40>
./kern/shell.S:111

    b           .OP_A_DONE
1c00140c:	50001800 	b	24(0x18) # 1c001424 <.OP_A_DONE>
...
1c001410:	1c00002c 	pcaddu12i	$r12,1(0x1)
1c001414:	28bc618c 	ld.w	$r12,$r12,-232(0xf18)
./kern/shell.S:115
    jirl        ra,t0,0x0
1c001418:	4c000181 	jirl	$r1,$r12,0
./kern/shell.S:116
    addi.w      s1,s1,-1
1c00141c:	02bfff18 	addi.w	$r24,$r24,-1(0xfff)
./kern/shell.S:117
    bne         s1,zero,.OP_A_DROP
1c001420:	5ffff300 	bne	$r24,$r0,-16(0x3fff0) # 1c001410 <.OP_A_DROP>
...
.OP_A_DONE:
    ld.w        s0,sp,0x0               // 恢复s0,s1
1c001424:	28800077 	ld.w	$r23,$r3,0
./kern/shell.S:121
    ld.w        s1,sp,0x4
1c001428:	28801078 	ld.w	$r24,$r3,4(0x4)
./kern/shell.S:122
    addi.w      sp,sp,0x8
1c00142c:	02802063 	addi.w	$r3,$r3,8(0x8)
./kern/shell.S:123
    b           .DONE
1c001430:	50015800 	b	344(0x158) # 1c001588 <.DONE>
...
1c001434:	1c00002c 	pcaddu12i	$r12,1(0x1)
1c001438:	28bc118c 	ld.w	$r12,$r12,-252(0xf04)
./kern/shell.S:127
    jirl        ra,t0,0x0
1c00143c:	4c000181 	jirl	$r1,$r12,0
./kern/shell.S:128
    or          $r21,a0,zero
1c001440:	00150095 	move	$r21,$r4
./kern/shell.S:130

    ori         a0,zero,TIMERSET        // 写TIMERSET(0x06)信号
1c001444:	03801804 	ori	$r4,$r0,0x6
./kern/shell.S:131
    la.global    t0,WRITESERIAL          // 告诉终端用户程序开始运行
1c001448:	1c00002c 	pcaddu12i	$r12,1(0x1)
1c00144c:	28bc518c 	ld.w	$r12,$r12,-236(0xf14)
./kern/shell.S:132
    jirl        ra,t0,0x0
1c001450:	4c000181 	jirl	$r1,$r12,0
./kern/shell.S:134

    la.local    ra,uregs                // 定位用户空间寄存器备份地址
1c001454:	1c00fde1 	pcaddu12i	$r1,2031(0x7ef)
1c001458:	02aeb021 	addi.w	$r1,$r1,-1108(0xbac)
./kern/shell.S:135
    st.w        sp,ra,31<<2             // 保存栈指针
1c00145c:	2981f023 	st.w	$r3,$r1,124(0x7c)
./kern/shell.S:136
    ld.w        $r2,ra,1<<2             // 装入$r2-$r31
1c001460:	28801022 	ld.w	$r2,$r1,4(0x4)
./kern/shell.S:137
    ld.w        $r3,ra,2<<2  
1c001464:	28802023 	ld.w	$r3,$r1,8(0x8)
./kern/shell.S:138
    ld.w        $r4,ra,3<<2  
1c001468:	28803024 	ld.w	$r4,$r1,12(0xc)
./kern/shell.S:139
    ld.w        $r5,ra,4<<2  
1c00146c:	28804025 	ld.w	$r5,$r1,16(0x10)
./kern/shell.S:140
    ld.w        $r6,ra,5<<2  
1c001470:	28805026 	ld.w	$r6,$r1,20(0x14)
./kern/shell.S:141
    ld.w        $r7,ra,6<<2  
1c001474:	28806027 	ld.w	$r7,$r1,24(0x18)
./kern/shell.S:142
    ld.w        $r8,ra,7<<2  
1c001478:	28807028 	ld.w	$r8,$r1,28(0x1c)
./kern/shell.S:143
    ld.w        $r9,ra,8<<2  
1c00147c:	28808029 	ld.w	$r9,$r1,32(0x20)
./kern/shell.S:144
    ld.w        $r10,ra,9<<2 
1c001480:	2880902a 	ld.w	$r10,$r1,36(0x24)
./kern/shell.S:145
    ld.w        $r11,ra,10<<2 
1c001484:	2880a02b 	ld.w	$r11,$r1,40(0x28)
./kern/shell.S:146
    ld.w        $r12,ra,11<<2
1c001488:	2880b02c 	ld.w	$r12,$r1,44(0x2c)
./kern/shell.S:147
    ld.w        $r13,ra,12<<2
1c00148c:	2880c02d 	ld.w	$r13,$r1,48(0x30)
./kern/shell.S:148
    ld.w        $r14,ra,13<<2
1c001490:	2880d02e 	ld.w	$r14,$r1,52(0x34)
./kern/shell.S:149
    ld.w        $r15,ra,14<<2
1c001494:	2880e02f 	ld.w	$r15,$r1,56(0x38)
./kern/shell.S:150
    ld.w        $r16,ra,15<<2
1c001498:	2880f030 	ld.w	$r16,$r1,60(0x3c)
./kern/shell.S:151
    ld.w        $r17,ra,16<<2
1c00149c:	28810031 	ld.w	$r17,$r1,64(0x40)
./kern/shell.S:152
    ld.w        $r18,ra,17<<2
1c0014a0:	28811032 	ld.w	$r18,$r1,68(0x44)
./kern/shell.S:153
    ld.w        $r19,ra,18<<2
1c0014a4:	28812033 	ld.w	$r19,$r1,72(0x48)
./kern/shell.S:154
    ld.w        $r20,ra,19<<2
1c0014a8:	28813034 	ld.w	$r20,$r1,76(0x4c)
./kern/shell.S:156
    # ld.w        $r21,ra,20<<2
    ld.w        $r22,ra,21<<2
1c0014ac:	28815036 	ld.w	$r22,$r1,84(0x54)
./kern/shell.S:157
    ld.w        $r23,ra,22<<2
1c0014b0:	28816037 	ld.w	$r23,$r1,88(0x58)
./kern/shell.S:158
    ld.w        $r24,ra,23<<2
1c0014b4:	28817038 	ld.w	$r24,$r1,92(0x5c)
./kern/shell.S:159
    ld.w        $r25,ra,24<<2
1c0014b8:	28818039 	ld.w	$r25,$r1,96(0x60)
./kern/shell.S:160
    ld.w        $r26,ra,25<<2
1c0014bc:	2881903a 	ld.w	$r26,$r1,100(0x64)
./kern/shell.S:161
    ld.w        $r27,ra,26<<2
1c0014c0:	2881a03b 	ld.w	$r27,$r1,104(0x68)
./kern/shell.S:162
    ld.w        $r28,ra,27<<2
1c0014c4:	2881b03c 	ld.w	$r28,$r1,108(0x6c)
./kern/shell.S:163
    ld.w        $r29,ra,28<<2
1c0014c8:	2881c03d 	ld.w	$r29,$r1,112(0x70)
./kern/shell.S:164
    ld.w        $r30,ra,29<<2
1c0014cc:	2881d03e 	ld.w	$r30,$r1,116(0x74)
./kern/shell.S:165
    ld.w        $r31,ra,30<<2
1c0014d0:	2881e03f 	ld.w	$r31,$r1,120(0x78)
./kern/shell.S:167

    jirl        ra,$r21,0x0
1c0014d4:	4c0002a1 	jirl	$r1,$r21,0
...
.USERRET2:
    la.local    ra,uregs                // 定位用户空间寄存器备份地址
1c0014d8:	1c00fde1 	pcaddu12i	$r1,2031(0x7ef)
1c0014dc:	02aca021 	addi.w	$r1,$r1,-1240(0xb28)
./kern/shell.S:170
    st.w        $r2,ra,1<<2             // 备份$r1-$r31
1c0014e0:	29801022 	st.w	$r2,$r1,4(0x4)
./kern/shell.S:171
    st.w        $r3,ra,2<<2  
1c0014e4:	29802023 	st.w	$r3,$r1,8(0x8)
./kern/shell.S:172
    st.w        $r4,ra,3<<2  
1c0014e8:	29803024 	st.w	$r4,$r1,12(0xc)
./kern/shell.S:173
    st.w        $r5,ra,4<<2  
1c0014ec:	29804025 	st.w	$r5,$r1,16(0x10)
./kern/shell.S:174
    st.w        $r6,ra,5<<2  
1c0014f0:	29805026 	st.w	$r6,$r1,20(0x14)
./kern/shell.S:175
    st.w        $r7,ra,6<<2  
1c0014f4:	29806027 	st.w	$r7,$r1,24(0x18)
./kern/shell.S:176
    st.w        $r8,ra,7<<2  
1c0014f8:	29807028 	st.w	$r8,$r1,28(0x1c)
./kern/shell.S:177
    st.w        $r9,ra,8<<2  
1c0014fc:	29808029 	st.w	$r9,$r1,32(0x20)
./kern/shell.S:178
    st.w        $r10,ra,9<<2 
1c001500:	2980902a 	st.w	$r10,$r1,36(0x24)
./kern/shell.S:179
    st.w        $r11,ra,10<<2 
1c001504:	2980a02b 	st.w	$r11,$r1,40(0x28)
./kern/shell.S:180
    st.w        $r12,ra,11<<2
1c001508:	2980b02c 	st.w	$r12,$r1,44(0x2c)
./kern/shell.S:181
    st.w        $r13,ra,12<<2
1c00150c:	2980c02d 	st.w	$r13,$r1,48(0x30)
./kern/shell.S:182
    st.w        $r14,ra,13<<2
1c001510:	2980d02e 	st.w	$r14,$r1,52(0x34)
./kern/shell.S:183
    st.w        $r15,ra,14<<2
1c001514:	2980e02f 	st.w	$r15,$r1,56(0x38)
./kern/shell.S:184
    st.w        $r16,ra,15<<2
1c001518:	2980f030 	st.w	$r16,$r1,60(0x3c)
./kern/shell.S:185
    st.w        $r17,ra,16<<2
1c00151c:	29810031 	st.w	$r17,$r1,64(0x40)
./kern/shell.S:186
    st.w        $r18,ra,17<<2
1c001520:	29811032 	st.w	$r18,$r1,68(0x44)
./kern/shell.S:187
    st.w        $r19,ra,18<<2
1c001524:	29812033 	st.w	$r19,$r1,72(0x48)
./kern/shell.S:188
    st.w        $r20,ra,19<<2
1c001528:	29813034 	st.w	$r20,$r1,76(0x4c)
./kern/shell.S:189
    st.w        $r21,ra,20<<2
1c00152c:	29814035 	st.w	$r21,$r1,80(0x50)
./kern/shell.S:190
    st.w        $r22,ra,21<<2
1c001530:	29815036 	st.w	$r22,$r1,84(0x54)
./kern/shell.S:191
    st.w        $r23,ra,22<<2
1c001534:	29816037 	st.w	$r23,$r1,88(0x58)
./kern/shell.S:192
    st.w        $r24,ra,23<<2
1c001538:	29817038 	st.w	$r24,$r1,92(0x5c)
./kern/shell.S:193
    st.w        $r25,ra,24<<2
1c00153c:	29818039 	st.w	$r25,$r1,96(0x60)
./kern/shell.S:194
    st.w        $r26,ra,25<<2
1c001540:	2981903a 	st.w	$r26,$r1,100(0x64)
./kern/shell.S:195
    st.w        $r27,ra,26<<2
1c001544:	2981a03b 	st.w	$r27,$r1,104(0x68)
./kern/shell.S:196
    st.w        $r28,ra,27<<2
1c001548:	2981b03c 	st.w	$r28,$r1,108(0x6c)
./kern/shell.S:197
    st.w        $r29,ra,28<<2
1c00154c:	2981c03d 	st.w	$r29,$r1,112(0x70)
./kern/shell.S:198
    st.w        $r30,ra,29<<2
1c001550:	2981d03e 	st.w	$r30,$r1,116(0x74)
./kern/shell.S:199
    st.w        $r31,ra,30<<2
1c001554:	2981e03f 	st.w	$r31,$r1,120(0x78)
./kern/shell.S:200
    la.local    a0,.USERRET2
1c001558:	1c000004 	pcaddu12i	$r4,0
1c00155c:	02be0084 	addi.w	$r4,$r4,-128(0xf80)
./kern/shell.S:201
    st.w        a0,ra,0<<2
1c001560:	29800024 	st.w	$r4,$r1,0
./kern/shell.S:202
    ld.w        sp,ra,31<<2
1c001564:	2881f023 	ld.w	$r3,$r1,124(0x7c)
./kern/shell.S:204

    la.global    t0,FLUSH_DCACHE         // 用户程序返回后统一写回 D-cache
1c001568:	1c00002c 	pcaddu12i	$r12,1(0x1)
1c00156c:	28b7e18c 	ld.w	$r12,$r12,-520(0xdf8)
./kern/shell.S:205
    jirl        ra,t0,0x0
1c001570:	4c000181 	jirl	$r1,$r12,0
./kern/shell.S:207
    
    ori         a0,zero,TIMETOKEN       // 发送TIMETOKEN(0x07)信号
1c001574:	03801c04 	ori	$r4,$r0,0x7
./kern/shell.S:208
    la.global    t0,WRITESERIAL          // 告诉终端用户程序结束运行
1c001578:	1c00002c 	pcaddu12i	$r12,1(0x1)
1c00157c:	28b7918c 	ld.w	$r12,$r12,-540(0xde4)
./kern/shell.S:209
    jirl        ra,t0,0x0
1c001580:	4c000181 	jirl	$r1,$r12,0
./kern/shell.S:211

    b           .DONE
1c001584:	50000400 	b	4(0x4) # 1c001588 <.DONE>
...
.DONE:
    b           SHELL                   // 交互循环
1c001588:	53fd57ff 	b	-684(0xffffd54) # 1c0012dc <SHELL>

1c00158c <WRITESERIAL>:
WRITESERIAL():
./kern/utils.S:32
    .global READSERIAL
...
#ifdef MACH_FPGA
    la.global    t1,SerialDataAddr
1c00158c:	1c00002d 	pcaddu12i	$r13,1(0x1)
1c001590:	28b701ad 	ld.w	$r13,$r13,-576(0xdc0)
./kern/utils.S:33
    ld.w         t1,t1,0x0
1c001594:	288001ad 	ld.w	$r13,$r13,0
./kern/utils.S:34
    addi.w       t1,t1,0x5              // LSR = UART base + 5
1c001598:	028015ad 	addi.w	$r13,$r13,5(0x5)
...
1c00159c:	280001ac 	ld.b	$r12,$r13,0
./kern/utils.S:37
    andi        t0,t0,0x20              // 截取写状态位 (THRE)
1c0015a0:	0340818c 	andi	$r12,$r12,0x20
./kern/utils.S:38
    bne         t0,zero,.WSERIAL        // 状态位非零可写进入写
1c0015a4:	5c000980 	bne	$r12,$r0,8(0x8) # 1c0015ac <.WSERIAL>
./kern/utils.S:39
    b           .TESTW                  // 检测验证，忙等待
1c0015a8:	53fff7ff 	b	-12(0xffffff4) # 1c00159c <.TESTW>
...
.WSERIAL:
    la.global    t1,SerialDataAddr
1c0015ac:	1c00002d 	pcaddu12i	$r13,1(0x1)
1c0015b0:	28b681ad 	ld.w	$r13,$r13,-608(0xda0)
./kern/utils.S:42
    ld.w         t1,t1,0x0
1c0015b4:	288001ad 	ld.w	$r13,$r13,0
./kern/utils.S:43
    st.b        a0,t1,0x0               // 写入
1c0015b8:	290001a4 	st.b	$r4,$r13,0
./kern/utils.S:44
    jirl        zero,ra,0x0
1c0015bc:	4c000020 	jirl	$r0,$r1,0
...
#ifdef MACH_FPGA
    la.global    t1,SerialDataAddr
1c0015c0:	1c00002d 	pcaddu12i	$r13,1(0x1)
1c0015c4:	28b631ad 	ld.w	$r13,$r13,-628(0xd8c)
./kern/utils.S:52
    ld.w         t1,t1,0x0
1c0015c8:	288001ad 	ld.w	$r13,$r13,0
./kern/utils.S:53
    addi.w       t1,t1,0x5              // LSR = UART base + 5
1c0015cc:	028015ad 	addi.w	$r13,$r13,5(0x5)
...
.TESTR:
    ld.b        t0,t1,0x0               // 查看串口状态
1c0015d0:	280001ac 	ld.b	$r12,$r13,0
./kern/utils.S:56
    andi        t0,t0,0x01              // 截取读状态位 (DR)
1c0015d4:	0340058c 	andi	$r12,$r12,0x1
./kern/utils.S:57
    bne         t0,zero,.RSERIAL        // 状态位非零可读进入读
1c0015d8:	5c000980 	bne	$r12,$r0,8(0x8) # 1c0015e0 <.RSERIAL>
./kern/utils.S:58
    b           .TESTR                  // 检测验证
1c0015dc:	53fff7ff 	b	-12(0xffffff4) # 1c0015d0 <.TESTR>
...
.RSERIAL:
    la.global    t1,SerialDataAddr
1c0015e0:	1c00002d 	pcaddu12i	$r13,1(0x1)
1c0015e4:	28b5b1ad 	ld.w	$r13,$r13,-660(0xd6c)
./kern/utils.S:61
    ld.w         t1,t1,0x0
1c0015e8:	288001ad 	ld.w	$r13,$r13,0
./kern/utils.S:62
    ld.b        a0,t1,0x0               // 读出
1c0015ec:	280001a4 	ld.b	$r4,$r13,0
./kern/utils.S:63
    jirl        zero,ra,0x0
1c0015f0:	4c000020 	jirl	$r0,$r1,0

1c0015f4 <READSERIALWORD>:
READSERIALWORD():
./kern/utils.S:69
...
1c0015f4:	02bfb063 	addi.w	$r3,$r3,-20(0xfec)
./kern/utils.S:70
    st.w        ra,sp,0x0
1c0015f8:	29800061 	st.w	$r1,$r3,0
./kern/utils.S:71
    st.w        s0,sp,0x4
1c0015fc:	29801077 	st.w	$r23,$r3,4(0x4)
./kern/utils.S:72
    st.w        s1,sp,0x8
1c001600:	29802078 	st.w	$r24,$r3,8(0x8)
./kern/utils.S:73
    st.w        s2,sp,0xC
1c001604:	29803079 	st.w	$r25,$r3,12(0xc)
./kern/utils.S:74
    st.w        s3,sp,0x10
1c001608:	2980407a 	st.w	$r26,$r3,16(0x10)
./kern/utils.S:76

    bl          READSERIAL
1c00160c:	57ffb7ff 	bl	-76(0xfffffb4) # 1c0015c0 <READSERIAL>
./kern/utils.S:77
    or          s0,zero,a0
1c001610:	00151017 	or	$r23,$r0,$r4
./kern/utils.S:78
    bl          READSERIAL
1c001614:	57ffafff 	bl	-84(0xfffffac) # 1c0015c0 <READSERIAL>
./kern/utils.S:79
    or          s1,zero,a0
1c001618:	00151018 	or	$r24,$r0,$r4
./kern/utils.S:80
    bl          READSERIAL
1c00161c:	57ffa7ff 	bl	-92(0xfffffa4) # 1c0015c0 <READSERIAL>
./kern/utils.S:81
    or          s2,zero,a0
1c001620:	00151019 	or	$r25,$r0,$r4
./kern/utils.S:82
    bl          READSERIAL
1c001624:	57ff9fff 	bl	-100(0xfffff9c) # 1c0015c0 <READSERIAL>
./kern/utils.S:83
    or          s3,zero,a0
1c001628:	0015101a 	or	$r26,$r0,$r4
./kern/utils.S:85

    andi        s0,s0,0x0FF             // 截取低八位
1c00162c:	0343fef7 	andi	$r23,$r23,0xff
./kern/utils.S:86
    andi        s3,s3,0x0FF
1c001630:	0343ff5a 	andi	$r26,$r26,0xff
./kern/utils.S:87
    andi        s2,s2,0x0FF
1c001634:	0343ff39 	andi	$r25,$r25,0xff
./kern/utils.S:88
    andi        s1,s1,0x0FF
1c001638:	0343ff18 	andi	$r24,$r24,0xff
./kern/utils.S:89
    or          a0,zero,s3
1c00163c:	00156804 	or	$r4,$r0,$r26
./kern/utils.S:90
    slli.w      a0,a0,8
1c001640:	0040a084 	slli.w	$r4,$r4,0x8
./kern/utils.S:91
    or          a0,a0,s2
1c001644:	00156484 	or	$r4,$r4,$r25
./kern/utils.S:92
    slli.w      a0,a0,8
1c001648:	0040a084 	slli.w	$r4,$r4,0x8
./kern/utils.S:93
    or          a0,a0,s1
1c00164c:	00156084 	or	$r4,$r4,$r24
./kern/utils.S:94
    slli.w      a0,a0,8
1c001650:	0040a084 	slli.w	$r4,$r4,0x8
./kern/utils.S:95
    or          a0,a0,s0  
1c001654:	00155c84 	or	$r4,$r4,$r23
./kern/utils.S:97

    ld.w        ra,sp,0x0
1c001658:	28800061 	ld.w	$r1,$r3,0
./kern/utils.S:98
    ld.w        s0,sp,0x4
1c00165c:	28801077 	ld.w	$r23,$r3,4(0x4)
./kern/utils.S:99
    ld.w        s1,sp,0x8
1c001660:	28802078 	ld.w	$r24,$r3,8(0x8)
./kern/utils.S:100
    ld.w        s2,sp,0xC
1c001664:	28803079 	ld.w	$r25,$r3,12(0xc)
./kern/utils.S:101
    ld.w        s3,sp,0x10
1c001668:	2880407a 	ld.w	$r26,$r3,16(0x10)
./kern/utils.S:102
    addi.w      sp,sp,0x14
1c00166c:	02805063 	addi.w	$r3,$r3,20(0x14)
./kern/utils.S:103
    jirl        zero,ra,0x0
...
1c00202c:	5002c000 	b	704(0x2c0) # 1c0022ec <FLUSH_DCACHE_AND_RETURN>
...
loop1end:
    b           FLUSH_DCACHE_AND_RETURN
1c0020ec:	50020000 	b	512(0x200) # 1c0022ec <FLUSH_DCACHE_AND_RETURN>
...
crn_end:
    b           FLUSH_DCACHE_AND_RETURN
1c002180:	50016c00 	b	364(0x16c) # 1c0022ec <FLUSH_DCACHE_AND_RETURN>
...
./kern/test.S:269
    b           FLUSH_DCACHE_AND_RETURN
1c002284:	50006800 	b	104(0x68) # 1c0022ec <FLUSH_DCACHE_AND_RETURN>
...
1c00228c:	2882e18c 	ld.w	$r12,$r12,184(0xb8)
./kern/test.S:281
    ld.w        t0, t0, 0x0
1c002290:	2880018c 	ld.w	$r12,$r12,0
./kern/test.S:282
    beq         t0, zero, 3f
1c002294:	58005580 	beq	$r12,$r0,84(0x54) # 1c0022e8 <FLUSH_DCACHE+0x60>
./kern/test.S:284

    la.global   t0, DCacheTotalSets
1c002298:	1c00000c 	pcaddu12i	$r12,0
1c00229c:	2882918c 	ld.w	$r12,$r12,164(0xa4)
./kern/test.S:285
...
1c0022a8:	2882318c 	ld.w	$r12,$r12,140(0x8c)
./kern/test.S:287
...
1c0022b4:	2882a18c 	ld.w	$r12,$r12,168(0xa8)
./kern/test.S:289
...
./kern/test.S:308
    beq         t7, zero, 2b
1c0022d8:	5bfff260 	beq	$r19,$r0,-16(0x3fff0) # 1c0022c8 <FLUSH_DCACHE+0x40>
./kern/test.S:312
    //     } // end for way
...
./kern/test.S:313
    bne         t0, t2, 1b
1c0022e0:	5fffe18e 	bne	$r12,$r14,-32(0x3ffe0) # 1c0022c0 <FLUSH_DCACHE+0x38>
./kern/test.S:316
    // } // end for set
...
1c0022ec <FLUSH_DCACHE_AND_RETURN>:
