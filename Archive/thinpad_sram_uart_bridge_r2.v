...
module thinpad_sram_uart_bridge(
    ...
    // 2-beat read: grant+addr_ok in S_IDLE, data_ok at end of S_ACCESS.
    ...
    wire base_data_data_ok = (base_state == S_ACCESS) && (base_cnt == SRAM_WAIT_LAST) && base_client_data;
    wire base_inst_data_ok = (base_state == S_ACCESS) && (base_cnt == SRAM_WAIT_LAST) && ~base_client_data;
    ...
    wire ext_data_data_ok = (ext_state == S_ACCESS) && (ext_cnt == SRAM_WAIT_LAST);
